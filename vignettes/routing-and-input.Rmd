...
Plumber will attempt to parse the request body in one using allowed [parsers](../reference/parsers.html). Any fields provided in the message body will be passed through as parameters to the function.
