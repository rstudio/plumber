...
Compared to `plumber::do_provision()` this option won't create a new droplet if you use [DigitalOcean](#digitalocean); it will run on your existing droplet instead.
