...
- Swagger documentation redirects from `/__swagger__/` to `/__docs__/`
  now use relative paths, ensuring compatibility with various hosting
  environments including RStudio Connect
  ([\#1016](https://github.com/rstudio/plumber/issues/1016),
  [\#1018](https://github.com/rstudio/plumber/issues/1018)).
...
- R Markdown include tests now use more robust HTML pattern matching for
  ...
  ([\#1012](https://github.com/rstudio/plumber/issues/1012)).
