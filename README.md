...
custom API in just two R commands. To deploy to DigitalOcean, check out the plumber companion package [`plumberDeploy`](https://github.com/meztez/plumberDeploy).
