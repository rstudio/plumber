...
* Update feather serializer to use the arrow package. The new default feather MIME type is `application/vnd.apache.arrow.file`. (@pachadotdev #849, @giqles #854)
* Add parquet serializer and parser by using the arrow package (@pachadotdev #849, @giqles #854)
* Add option to use `readr::write_file` in place of `base::writeBin` to write binary files before loading (@giqles #854)
